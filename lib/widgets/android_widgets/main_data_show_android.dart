...
import 'package:test_app_weather/widgets/android_widgets/forecast_card_android.dart';

class MainDataShow_Android extends StatelessWidget {
  MainDataShowState state;
  MainDataShow_Android({this.state});
            ...
            Container(
              ...
              child: ListView.separated(
                ...
                itemBuilder: (context, index) => Container(
                  ...
                  height: 160,
                  color: Colors.black87,
                  child: forecastCard(state.forecastObject, index),
                ),
              ),
            ),
            Padding(
